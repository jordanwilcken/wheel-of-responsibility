...
var _user$project$Angle$fromDegrees = function (someFloat) {
	return _user$project$Angle$Angle(someFloat);
};
var _user$project$Angle$fromRadians = function (radiansFloat) {
	return _user$project$Angle$Angle(radiansFloat * (360 / (2 * _elm_lang$core$Basics$pi)));
};

var _user$project$FloatOps$justTheDecimalPart = function (someFloat) {
	var absoluteFloat = _elm_lang$core$Basics$abs(someFloat);
	...
	return negateIfNecessary(
		A2(
			...
			_elm_lang$core$Basics$toFloat(
				_elm_lang$core$Basics$floor(absoluteFloat))));
};

var _user$project$JobWheel$firstToLast = function (someList) {
...
var _user$project$JobWheel$dropLast = function (someList) {
	var numberToTake = _elm_lang$core$List$length(someList) - 1;
	return A2(_elm_lang$core$List$take, numberToTake, someList);
};
var _user$project$JobWheel$getLast = function (someList) {
	return _elm_lang$core$List$head(
		_elm_lang$core$List$reverse(someList));
};
var _user$project$JobWheel$lastToFirst = function (someList) {
	var _p1 = _user$project$JobWheel$getLast(someList);
	if (_p1.ctor === 'Just') {
		return _user$project$JobWheel$dropLast(
			{ctor: '::', _0: _p1._0, _1: someList});
	} else {
		return someList;
	}
};
var _user$project$JobWheel$shiftTowardsTail = F2(
	function (howMuch, someList) {
		shiftTowardsTail:
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(howMuch, 0) < 0) {
				return A2(
					_user$project$JobWheel$shiftTowardsHead,
					_elm_lang$core$Basics$negate(howMuch),
					someList);
			} else {
				if (_elm_lang$core$Native_Utils.eq(howMuch, 0)) {
					return someList;
				} else {
					var _v2 = howMuch - 1,
						_v3 = _user$project$JobWheel$lastToFirst(someList);
					howMuch = _v2;
					someList = _v3;
					continue shiftTowardsTail;
				}
			}
		}
	});
var _user$project$JobWheel$shiftTowardsHead = F2(
	function (howMuch, someList) {
		shiftTowardsHead:
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(howMuch, 0) < 0) {
				return A2(
					_user$project$JobWheel$shiftTowardsTail,
					_elm_lang$core$Basics$negate(howMuch),
					someList);
			} else {
				if (_elm_lang$core$Native_Utils.eq(howMuch, 0)) {
					...
					var _v4 = howMuch - 1,
						_v5 = _user$project$JobWheel$firstToLast(someList);
					howMuch = _v4;
					someList = _v5;
					continue shiftTowardsHead;
				}
			}
		}
	});
var _user$project$JobWheel$shiftList = F2(
	function (howMuch, someList) {
...
var _user$project$JobWheel$listThem = function (responsiblePeople) {
	return A2(
		_elm_lang$core$List$map,
		function (person) {
			return {
...
var _user$project$JobWheel$getPositiveDecimal = function (theFloat) {
	return theFloat - _elm_lang$core$Basics$toFloat(
...
var _user$project$JobWheel$changesThisTurn = F2(
	function (time, jobWheel) {
		...
		return _elm_lang$core$Basics$toFloat(
			_user$project$JobWheel$changesPerTurn(jobWheel)) * currentTurnDecimal;
	});
var _user$project$JobWheel$timeSinceLastChange = F2(
	function (time, jobWheel) {
		return A2(
			F2(
				function (x, y) {
			...
			_user$project$FloatOps$justTheDecimalPart(
...
var _user$project$JobWheel$rotateJobsNTimes = F2(
	function (n, responsiblePeople) {
		var startingList = _user$project$JobWheel$listPeople(responsiblePeople);
...
var _user$project$WheelView$toSection = F2(
	function (svgConfig, person) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg$text(jobText),
				_1: {ctor: '[]'}
			});
	});
			...
			function (index, someString) {
				var angle = A2(
					...
					A2(
						...
						360 / _elm_lang$core$Basics$toFloat(
...
var _user$project$WheelView$viewWheel = F2(
	function (svgConfig, _p1) {
		var _p2 = _p1;
		var _p4 = _p2._0;
		var names = A2(
			_elm_lang$core$List$map,
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$class(svgConfig.$class),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$width(
						_elm_lang$core$Basics$toString(svgConfig.width)),
...
var _user$project$WheelView$Person = F2(
	function (a, b) {
		return {name: a, job: b};
	});
var _user$project$WheelView$SvgConfig = F3(
	function (a, b, c) {
		return {$class: a, width: b, height: c};
	});
...
var _user$project$WheelForm$newParticipant = {name: 'Mystery Date', job: 'be charming'};
...
var _user$project$WheelForm$Person = F2(
	function (a, b) {
		return {name: a, job: b};
	});
...
var _user$project$WheelForm$sizeParticipants = F2(
	function (size, _p19) {
		...
		var updatedParticipants = (_elm_lang$core$Native_Utils.cmp(difference, 0) > 0) ? A2(
			_elm_lang$core$List$append,
			_p21.participants,
			A2(_elm_lang$core$List$repeat, difference, _user$project$WheelForm$newParticipant)) : A2(_elm_lang$core$List$take, count, _p21.participants);
		return _user$project$WheelForm$WheelForm(
			_elm_lang$core$Native_Utils.update(
				_p21,
			...
			return A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('input-label'),
							_1: {
								ctor: '::',
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('wheel-input left-column-input'),
									_1: {
										ctor: '::',
...
var _user$project$WheelForm$viewPreview = F2(
	function (svgConfig, participants) {
		var thePreview = A2(
			...
			{
				ctor: '_Tuple2',
				_0: A2(_elm_lang$core$List$map, _user$project$WheelForm$toStaticJobViewPerson, participants),
				_1: _user$project$Angle$fromDegrees(0)
			});
		return A2(_elm_lang$html$Html$map, _user$project$WheelForm$PreviewMsg, thePreview);
	});
...
var _user$project$WheelForm$init = function () {
	var participants = {
		ctor: '::',
		_0: {name: 'Leonardo', job: 'invent stuff'},
		_1: {
			ctor: '::',
			_0: {name: 'Donatello', job: 'sculpt David'},
			_1: {
				ctor: '::',
				_0: {name: 'Michaelangelo', job: 'paint the chapel'},
				_1: {
					ctor: '::',
					_0: {name: 'Raphael', job: 'wash the Turle Van'},
					_1: {ctor: '[]'}
				}
			}
		}
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('use the wheel above as a template'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('How many participants? (min 2, max 20)'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
...
var _user$project$Main$viewJob = F3(
	function (xVal, yVal, job) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg$text(job.description),
				_1: {ctor: '[]'}
			});
	});
			...
			return A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg$text('I don\'t know who is doing what right now.'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				});
...
var _user$project$Main$viewOptionsForWheels = function (model) {
			...
			_0: A2(
				_elm_lang$svg$Svg$text_,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$x(
							_elm_lang$core$Basics$toString((svgConfig.width / 2) | 0)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$y(
								_elm_lang$core$Basics$toString((svgConfig.height / 2) | 0)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$textAnchor('middle'),
								_1: {ctor: '[]'}
...
var _user$project$Main$svgConfig = {$class: 'wheel-view', width: 800, height: 800};
var _user$project$Main$SvgConfig = F3(
	function (a, b, c) {
		return {$class: a, width: b, height: c};
	});
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {wheels: a, selectedWheel: b, wheelOrientation: c, currentJobs: d, timeOfNextChange: e, wheelForm: f, error: g, displayMode: h};
	});
var _user$project$Main$WheelOrientation = F3(
	function (a, b, c) {
		return {personList: a, angleInDegrees: b, angleInRadians: c};
	});
...
var _user$project$Main$RealTime = {ctor: 'RealTime'};
...
var _user$project$Main$changeWheelOrientation = F2(
	function (orientation, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				wheelOrientation: _user$project$Main$Known(orientation)
			});
	});
var _user$project$Main$determineTimeDependentState = F2(
	function (time, model) {
		var selectedWheel = _user$project$Main$justTheValue(model.selectedWheel);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				currentJobs: _user$project$Main$Known(
					A2(_user$project$JobWheel$determineJobsAt, time, selectedWheel)),
				timeOfNextChange: _user$project$Main$Known(
					A2(_user$project$JobWheel$timeOfNextChange, time, selectedWheel))
			});
	});
var _user$project$Main$Unknown = {ctor: 'Unknown'};
var _user$project$Main$changeSelectedWheel = F2(
	function (newlySelected, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{selectedWheel: newlySelected, currentJobs: _user$project$Main$Unknown, timeOfNextChange: _user$project$Main$Unknown});
	});
var _user$project$Main$WheelViewMsg = {ctor: 'WheelViewMsg'};
var _user$project$Main$ToggleDisplayMode = {ctor: 'ToggleDisplayMode'};
...
var _user$project$Main$init = function () {
	...
	var startingModel = {
		...
		displayMode: _user$project$Main$Static
	};
...
var _user$project$Main$viewWheel = function (model) {
	var jobsSvg = function () {
		var _p28 = model.displayMode;
		if (_p28.ctor === 'RealTime') {
			var _p29 = model.wheelOrientation;
			if (_p29.ctor === 'Known') {
				var _p30 = _p29._0;
				var wheelView = A2(
					...
					_user$project$Main$svgConfig,
					{
						ctor: '_Tuple2',
						_0: _p30.personList,
						_1: _user$project$Angle$fromDegrees(_p30.angleInDegrees)
					});
				return A2(
					_elm_lang$html$Html$map,
					_elm_lang$core$Basics$always(_user$project$Main$WheelViewMsg),
					wheelView);
			} else {
				return _user$project$Main$viewLoading(_user$project$Main$svgConfig);
			}
		} else {
			var _p31 = model.wheelOrientation;
			if (_p31.ctor === 'Known') {
				var _p32 = _p31._0;
				var wheelView = A2(
					_user$project$WheelView$viewWheel,
					{$class: 'wheel-view', width: 800, height: 800},
					{
						ctor: '_Tuple2',
						_0: _p32.personList,
						_1: _user$project$Angle$fromDegrees(_p32.angleInDegrees)
					});
				return A2(
					_elm_lang$html$Html$map,
					_elm_lang$core$Basics$always(_user$project$Main$WheelViewMsg),
	...
	var _p33 = _elm_lang$core$Basics$identity(model.selectedWheel);
	var selectedId = _p33._0;
	var selectedWheel = _p33._1;
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$select,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SelectedWheelChanged),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(
									_elm_lang$core$Basics$toString(selectedId)),
								_1: {ctor: '[]'}
							}
						}
					},
					_user$project$Main$viewOptionsForWheels(model)),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$input,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id('show-realtime'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$type_('checkbox'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ToggleDisplayMode),
									_1: {ctor: '[]'}
								}
							}
						},
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$for('show-realtime'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('display in real time'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
		...
		switch (_p34.ctor) {
			case 'ToggleDisplayMode':
				var newDisplayMode = function () {
					var _p35 = model.displayMode;
					if (_p35.ctor === 'RealTime') {
			...
			case 'TimeReceived':
				...
				var timeForAChange = function () {
					var _p36 = model.displayMode;
					if (_p36.ctor === 'Static') {
						var _p37 = model.timeOfNextChange;
						if (_p37.ctor === 'Known') {
							return (_elm_lang$core$Native_Utils.cmp(_p40, _p37._0) > -1) ? true : false;
						} else {
							return true;
						}
					} else {
				...
				if (timeForAChange) {
					...
					var wheelOrientation = {
						...
						angleInRadians: _elm_lang$core$Basics$degrees(reducedDegrees)
					};
					return A2(
						_Fresheyeball$elm_return$Return$map,
						...
						A2(
							_Fresheyeball$elm_return$Return$map,
							_user$project$Main$determineTimeDependentState(_p40),
			...
			case 'SelectedWheelChanged':
				var findWheelResult = A2(
					...
					_elm_lang$core$String$toInt(_p34._0));
				var _p41 = findWheelResult;
				if (_p41.ctor === 'Ok') {
					return A2(
						_Fresheyeball$elm_return$Return$map,
						_user$project$Main$changeSelectedWheel(_p41._0),
						{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'WheelFormMsg':
				return A2(
					...
					A2(
						...
						A2(_user$project$WheelForm$update, _p34._0, model.wheelForm)));
			case 'MakeCreateCmd':
				var makeJobWheel = function (time) {
					...
					if (_p42.ctor === 'Ok') {
						return _elm_lang$core$Task$succeed(_p42._0);
					} else {
						return _elm_lang$core$Task$fail(_p42._0);
					}
				};
				...
				var wheelResultToMsg = function (wheelResult) {
					var _p43 = wheelResult;
					if (_p43.ctor === 'Ok') {
						return _user$project$Main$MakeSaveCmd(_p43._0);
					} else {
						return A2(
							_elm_lang$core$Basics$always,
							_user$project$Main$Nevermind,
							A2(_elm_lang$core$Debug$log, 'create wheel error: ', _p43._0));
					}
				};
				return A2(
					...
					{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
			case 'MakeSaveCmd':
				var encodedJobWheel = _user$project$JobWheel$encode(_p34._0);
				return A2(
					_Fresheyeball$elm_return$Return$command,
			...
			case 'WheelsReceived':
				return A2(
					_Fresheyeball$elm_return$Return$map,
					_user$project$Main$addDistinctWheels(_p34._0),
					{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
			case 'ErrorCreatingJobWheel':
				return A2(
					_Fresheyeball$elm_return$Return$map,
					_user$project$Main$setError(_p34._0),
					{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
			case 'WheelViewMsg':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
