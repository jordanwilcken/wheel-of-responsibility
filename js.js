...
var _user$project$JobWheel$simplePeople = {
	first: A3(
		...
		_elm_lang$core$Maybe$Just(
			A2(_user$project$JobWheel$Job, 1, 'the participants'))),
	middle: {
		ctor: '::',
		_0: A3(
			_user$project$JobWheel$ResponsiblePerson,
			...
			'is',
			_elm_lang$core$Maybe$Just(
				A2(_user$project$JobWheel$Job, 1, 'change jobs'))),
		_1: {
			ctor: '::',
			_0: A3(
				_user$project$JobWheel$ResponsiblePerson,
				...
				'a',
				_elm_lang$core$Maybe$Just(
					A2(_user$project$JobWheel$Job, 1, 'every'))),
			_1: {
				ctor: '::',
				_0: A3(
					_user$project$JobWheel$ResponsiblePerson,
					...
					'job',
					_elm_lang$core$Maybe$Just(
						A2(_user$project$JobWheel$Job, 1, '5'))),
				_1: {ctor: '[]'}
			}
		}
	},
	last: A3(
		...
		'wheel',
		_elm_lang$core$Maybe$Just(
			A2(_user$project$JobWheel$Job, 2, 'seconds')))
};
...
var _user$project$JobWheel$simpleWheel = _user$project$JobWheel$JobWheel(
	{description: 'Example Job Wheel', timeCreated: 0, period: 25 * _elm_lang$core$Time$second, origin: _user$project$JobWheel$simplePeople, rotationDirection: _user$project$JobWheel$Clockwise});
	...
	function (svgConfig, _p1) {
		...
		return A2(
			_elm_lang$svg$Svg$svg,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$fontSize(svgConfig.fontSize),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$width(
							_elm_lang$core$Basics$toString(svgConfig.width)),
...
var _user$project$WheelView$SvgConfig = F4(
	function (a, b, c, d) {
		return {$class: a, fontSize: b, width: c, height: d};
	});
...
var _user$project$WheelForm$sizeParticipants = F2(
	function (size, _p19) {
		var _p20 = _p19;
		var _p21 = _p20._0;
		var count = (_elm_lang$core$Native_Utils.cmp(size, _user$project$WheelForm$maxParticipants) > 0) ? _user$project$WheelForm$maxParticipants : size;
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(_p29.description),
												_1: {ctor: '[]'}
											}
										}
									},
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{$class: 'wheel-preview', fontSize: '18', height: 600, width: 600},
										_p29.participants),
									_1: {
										ctor: '::',
										_0: A2(
...
var _user$project$Main$svgConfig = {$class: 'wheel-view', fontSize: '18', width: 800, height: 800};
var _user$project$Main$SvgConfig = F4(
	function (a, b, c, d) {
		return {$class: a, fontSize: b, width: c, height: d};
	});
					...
					_elm_lang$html$Html$select,
					{
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html_Events$on,
								'change',
								A2(_elm_lang$core$Json_Decode$map, _user$project$Main$SelectedWheelChanged, _elm_lang$html$Html_Events$targetValue)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(
